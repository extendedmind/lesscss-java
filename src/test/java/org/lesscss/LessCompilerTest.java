...
public class LessCompilerTest {
    ...
    private static final String lessJsURLToString = "less-rhino-1.7.4.js";
    ...
    public void testNewLessCompiler() throws Exception {
        assertEquals(LessCompiler.class.getClassLoader().getResource("META-INF/less-rhino-1.7.4.js"), FieldUtils.readField(lessCompiler, "lessJs", true));
        assertEquals(LessCompiler.class.getClassLoader().getResource("META-INF/lessc-rhino-1.7.4.js"), FieldUtils.readField(lessCompiler, "lesscJs", true));
